package com.example.final_project_training.Config;

import com.example.final_project_training.Service.MyUserDetailsService;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        http.csrf().disable()
                ...
                .requestMatchers("/api/v1/training/**").hasAuthority("Coach")
